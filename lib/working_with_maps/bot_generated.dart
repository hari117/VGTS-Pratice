...
class GoogleMaps {
  ...
  factory GoogleMaps.fromJson(Map<String, dynamic> json) => GoogleMaps(
    ...
    routes: json["routes"] == null ? null : List<RouteClass>.from(json["routes"].map((x) => RouteClass.fromJson(x))),
...
class Leg {
  ...
  factory Leg.fromJson(Map<String, dynamic> json) => Leg(
    ...
    steps: json["steps"] == null ? null : List<StepClass>.from(json["steps"].map((x) => StepClass.fromJson(x))),
...
class StepClass {
  ...
  factory StepClass.fromJson(Map<String, dynamic> json) => StepClass(
    distance: json["distance"] == null ? null : Distance.fromJson(json["distance"]),
    duration: json["duration"] == null ? null : Distance.fromJson(json["duration"]),
    endLocation: json["end_location"] == null ? null : Northeast.fromJson(json["end_location"]),
